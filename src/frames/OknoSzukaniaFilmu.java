...
public class OknoSzukaniaFilmu extends javax.swing.JPanel {
GlowneOkno parent;
     ...
     */
    public OknoSzukaniaFilmu(GlowneOkno p) {
        this.parent = p;
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Statement statement;
         try{
            ...
            ResultSet rs = statement.executeQuery("Select * from Filmy where tytul like'"+szukanaNazwa+"%'");
            while(rs.next()){
                String a = "id->"+String.valueOf(rs.getInt("uid"))+" "+rs.getString("tytul")+"\n";
                jTextArea1.append(a);
            }
